...
public class Part1Client {
    public static void main(String[] args) {
        ...
        */
    	TotalPointsGradebook book1 = new TotalPointsGradebook();
    	book1.add(new Assignment("Lab 1", 10, 9));
    	book1.add(new Assignment("Lab 2", 10, 10));
    	book1.add(new Assignment("Lab 3", 10, 8));
    	book1.add(new Assignment("Lab 4", 15, 13));
    	book1.add(new Assignment("Quiz 1", 5, 5));
    	book1.add(new Assignment("Quiz 2", 5, 4));
    	book1.add(new Assignment("Quiz 3", 5, 5));
    	book1.add(new Assignment("Test 1", 50, 46));
    	book1.add(new Assignment("Test 2", 50, 42));
    	book1.add(new Assignment("Final Exam", 50, 43));
    	System.out.println("Grade: "+book1.calculateGrade());
    }
}
